...
describe("chai-datetime", function () {
  describe("helpers", function () {
    describe("afterDate", function () {
      describe("when given two identical date objects", function () {
        ...
        it("reAturns false", function () {
          afterDate(this.actual, this.expected).should.be.eq(false);
        });

        it("should not be affected by time zones", function () {
          var midnight = new Date(2014, 0, 1, 0);
          var endOfDay = new Date(2014, 0, 1, 23);
          afterDate(endOfDay, midnight).should.be.false;
        });
      });
      ...
      describe("when given the actual is after the expected", function () {
        ...
        it("returns true", function () {
          afterDate(this.actual, this.expected).should.be.eq(true);
        });
      });
    ...
    describe("beforeDate", function () {
      describe("when given two identical date objects", function () {
        ...
        it("returns false", function () {
          beforeDate(this.actual, this.expected).should.be.eq(false);
        });

        it("should not be affected by time zones", function () {
          var midnight = new Date(2014, 0, 1, 0);
          var endOfDay = new Date(2014, 0, 1, 23);
          beforeDate(midnight, endOfDay).should.be.false;
        });
      });
      ...
      describe("when given the actual is before the expected", function () {
        ...
        it("returns true", function () {
          beforeDate(this.actual, this.expected).should.be.eq(true);
        });
      });
        ...
        describe("when negated", function () {
          it("fails", function () {
            ...
            (function () {
              ...
              "expected " +
                formatTime(test.subject) +
                " to not equal " +
                formatTime(test.same)
            ));
          });
        });
      });
          ...
          it("fails", function () {
            ...
            (function () {
              ...
              "expected " +
                ...
                formatTime(test.subjetPlus3seconds)
            ));
          });
        });
      });
  ...
  describe("beforeDate", function () {
    ...
    describe("when given two identical date objects", function () {
      ...
      it("fails", function () {
        ...
        }.should.fail("expected Thu May 30 2013 to be before Thu May 30 2013"));
      });
  ...
  describe("afterDate", function () {
    ...
    describe("when given two identical date objects", function () {
      ...
      it("fails", function () {
        ...
        }.should.fail("expected Thu May 30 2013 to be after Thu May 30 2013"));
      });
  ...
  describe("formatTime", function () {
    ...
    describe("printing the timezone", function () {
      it("prints the local timezone", function () {
        ...
        formatTime(date).should.match(/.* \([+-]\d\d:\d\d\)$/);
      });
    });
  });
  ...
  describe("getFormattedTimezone", function () {
    ...
    it("should use a + to indicate the timezone is ahead of UTC", function () {
      getFormattedTimezone(-525).should.equal("+08:45");
    });

    it("should use a - to indicate the timezone is behind of UTC", function () {
      getFormattedTimezone(300).should.equal("-05:00");
    });

    it("should use a + when we are in the UTC timezone", function () {
      getFormattedTimezone(0).should.equal("+00:00");
    });
  });
